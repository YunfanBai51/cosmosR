...
Runs COSMOS from signaling to metabolism. This function uses CARNIVAL to
find a subset of the prior knowledge network based on optimisation that
...
to prepare inputs, measurements and prior knowledge network.
...
#> 16:58:24 17.03.2026 Carnival flavour: vanilla
#> 16:58:24 17.03.2026 Generating variables for lp problem
#> 16:58:24 17.03.2026 Done: generating variables for lp problem
#> Saving preprocessed data.
#> Done: saving parsed data: /__w/cosmosR/cosmosR/docs/reference//parsedData_t16_58_24d17_03_2026n69.RData
#> 16:58:24 17.03.2026 Generating formulation for LP problem
#> 16:58:24 17.03.2026 Done: generating formulation for LP problem.
#> Saving LP file
#> Done: Saving LP file: /__w/cosmosR/cosmosR/docs/reference//lpFile_t16_58_24d17_03_2026n69.lp
#> 16:58:24 17.03.2026 Solving LP problem
...
#> 16:58:24 17.03.2026 Done: solving LP problem.
#> 16:58:24 17.03.2026 Getting the solution matrix
#> 16:58:24 17.03.2026 Done: getting the solution matrix.
#> 16:58:24 17.03.2026 Exporting solution matrix
#> 16:58:24 17.03.2026 Done: exporting solution matrix.
#> Cleaning intermediate files
#> Done: cleaning
#> 16:58:24 17.03.2026 All tasks finished.
#> 
...
#> 16:58:24 17.03.2026 Done: generating variables for lp problem
#> Saving preprocessed data.
#> Done: saving parsed data: /__w/cosmosR/cosmosR/docs/reference//parsedData_t16_58_24d17_03_2026n5.RData
#> 16:58:24 17.03.2026 Generating formulation for LP problem
#> 16:58:24 17.03.2026 Done: generating formulation for LP problem.
#> Saving LP file
#> Done: Saving LP file: /__w/cosmosR/cosmosR/docs/reference//lpFile_t16_58_24d17_03_2026n5.lp
#> 16:58:24 17.03.2026 Solving LP problem
#> Parsing .lp file for lpSolve
#> Rows: 882 Columns: 1
#> ── Column specification ────────────────────────────────────────────────────────
...
#> ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
#> Done: parsing .lp file for lpSolve
#> 16:58:25 17.03.2026 Done: solving LP problem.
#> 16:58:25 17.03.2026 Getting the solution matrix
#> 16:58:25 17.03.2026 Done: getting the solution matrix.
#> 16:58:25 17.03.2026 Exporting solution matrix
#> 16:58:25 17.03.2026 Done: exporting solution matrix.
#> Cleaning intermediate files
#> Done: cleaning
#> 16:58:25 17.03.2026 All tasks finished.
#> 
#> --- End of the CARNIVAL pipeline --- 
```
